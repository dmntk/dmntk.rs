...
fn ex_0044() {
    ...
    eq_output_components(
        rec,
        &[Some("Applicant risk rating"), Some("Special Discount")],
    );
    eq_output_values(rec, EMPTY_OPT_VECTOR);
    eq_output_entries(
        rec,
...
fn test_err_01() {
    assert_eq!(
        ...
        Recognizer::recognize(EX_ERR_01, false)
            .err()
            .unwrap()
            .to_string()
    );
...
fn test_err_02() {
    assert_eq!(
        ...
        Recognizer::recognize(EX_ERR_02, false)
            .err()
            .unwrap()
            .to_string()
    );
...
fn test_err_03() {
    assert_eq!(
        ...
        Recognizer::recognize(EX_ERR_03, false)
            .err()
            .unwrap()
            .to_string()
    );
...
fn test_err_04() {
    assert_eq!(
        ...
        Recognizer::recognize(EX_ERR_04, false)
            .err()
            .unwrap()
            .to_string()
    );
...
fn test_err_05() {
    assert_eq!(
        ...
        Recognizer::recognize(EX_ERR_05, false)
            .err()
            .unwrap()
            .to_string()
    );
...
fn test_err_06() {
    assert_eq!(
        "<RecognizerError> too many rows in input clause",
        Recognizer::recognize(EX_ERR_06, false)
            .err()
            .unwrap()
            .to_string()
    );
...
fn test_err_07() {
    assert_eq!(
        ...
        Recognizer::recognize(EX_ERR_07, false)
            .err()
            .unwrap()
            .to_string()
    );
...
fn test_err_08() {
    assert_eq!(
        ...
        Recognizer::recognize(EX_ERR_08, false)
            .err()
            .unwrap()
            .to_string()
    );
