...
fn _0435() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_multiply_lhs_null_by_rhs_date",
        &CTX,
        r#"null"#,
    );
}
...
fn _0437() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_multiply_lhs_null_by_rhs_time",
        &CTX,
        r#"null"#,
    );
}
...
fn _0438() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_multiply_lhs_null_by_rhs_list",
        &CTX,
        r#"null"#,
    );
}
...
fn _0444() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_multiply_lhs_null_by_rhs_null",
        &CTX,
        r#"null"#,
    );
}
...
fn _0620() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_number_to_rhs_null",
        &CTX,
        r#"null"#,
    );
}
...
fn _0751() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_number",
        &CTX,
        r#"null"#,
    );
}
...
fn _0752() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_string",
        &CTX,
        r#"null"#,
    );
}
...
fn _0753() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_boolean",
        &CTX,
        r#"null"#,
    );
}
...
fn _0754() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_date",
        &CTX,
        r#"null"#,
    );
}
...
fn _0756() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_time",
        &CTX,
        r#"null"#,
    );
}
...
fn _0757() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_list",
        &CTX,
        r#"null"#,
    );
}
...
fn _0758() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_context",
        &CTX,
        r#"null"#,
    );
}
...
fn _0761() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_range",
        &CTX,
        r#"null"#,
    );
}
...
fn _0762() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_function",
        &CTX,
        r#"null"#,
    );
}
...
fn _0763() {
    assert_decision(
        &MODEL_EVALUATOR,
        &MODEL_NAMESPACE,
        "error_when_add_lhs_null_to_rhs_null",
        &CTX,
        r#"null"#,
    );
}
