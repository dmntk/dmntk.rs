...
#[test]
fn _0010() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "multiply_lhs_number_by_rhs_dtDuration_006", &CTX, r#"PT0S"#);
}
...
#[test]
fn _0018() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "multiply_lhs_dtDuration_by_rhs_number_006", &CTX, r#"PT0S"#);
}
...
#[test]
fn _0027() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "multiply_lhs_number_by_rhs_ymDuration_007", &CTX, r#"P0M"#);
}
...
#[test]
fn _0037() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "multiply_lhs_ymDuration_by_rhs_number_007", &CTX, r#"P0M"#);
}
...
#[test]
fn _0185() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "subtract_lhs_dateAndTime_minus_rhs_dateAndTime_010", &CTX, r#"PT0S"#);
}
...
#[test]
fn _0229() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "subtract_lhs_date_minus_rhs_dateAndTime_004", &CTX, r#"PT0S"#);
}
