...
mod tests {
    ...
    fn build_evaluators(xml: &str) -> (InputDataEvaluator, ItemDefinitionEvaluator) {
        ...
        (
            InputDataEvaluator::new(&def_definitions),
    ...
    fn _0001_1() {
        ...
        assert_eq!(
            Some((
                Name::new(&["Full", "Name"]),
                Value::String("Phillip".to_string())
            )),
            input_data_evaluator.evaluate(
                &DefKey::new(NAMESPACE, "_cba86e4d-e91c-46a2-9176-e9adf88e15db"),
                &Value::Context(context),
    ...
    fn _0001_2() {
        ...
        assert_eq!(
            Some((
                Name::new(&["Full", "Name"]),
                Value::Null(Some("after coercion".to_string()))
            )),
            input_data_evaluator.evaluate(
                &DefKey::new(NAMESPACE, "_cba86e4d-e91c-46a2-9176-e9adf88e15db"),
                &Value::Context(context),
