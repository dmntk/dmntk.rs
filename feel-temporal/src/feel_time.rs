...
mod tests {
    ...
    fn test_time_from_str() {
        ...
        eq_time(
            ...
            9,
            0,
            FeelZone::Zone("Etc/UTC".to_string()),
            "16:37:09@Etc/UTC",
        );
        eq_time(
            17,
            ...
            9,
            0,
            FeelZone::Zone("Europe/London".to_string()),
            "17:37:09@Europe/London",
        );
        eq_time(
            18,
            37,
            9,
            0,
            FeelZone::Zone("Europe/Warsaw".to_string()),
            "18:37:09@Europe/Warsaw",
        );
        eq_time(
            18,
            37,
            9,
            0,
            FeelZone::Zone("Africa/Johannesburg".to_string()),
            "18:37:09@Africa/Johannesburg",
        );
        eq_time(
            10,
            37,
            9,
            0,
            FeelZone::Zone("America/Vancouver".to_string()),
            "10:37:09@America/Vancouver",
        );
        eq_time(
            13,
            37,
            9,
            0,
            FeelZone::Zone("America/New_York".to_string()),
            "13:37:09@America/New_York",
        );
    }
    ...
    fn test_time_from_str_errors() {
        assert_eq!(
            Err(err_invalid_time_literal("24:37:09")),
            FeelTime::from_str("24:37:09")
        );
        assert_eq!(
            Err(err_invalid_time_literal("18:60:09")),
            FeelTime::from_str("18:60:09")
        );
        assert_eq!(
            Err(err_invalid_time_literal("05:12:60")),
            FeelTime::from_str("05:12:60")
        );
    }
    ...
    fn test_eq() {
        ...
        assert!(
            (FeelTime(0, 0, 0, 0, FeelZone::Utc) != FeelTime(0, 0, 0, 0, FeelZone::Offset(18_000)))
        );
        assert!(
            (FeelTime(0, 0, 0, 0, FeelZone::Utc)
                != FeelTime(0, 0, 0, 0, FeelZone::Zone("Europe/Warsaw".to_string())))
        );
    }
