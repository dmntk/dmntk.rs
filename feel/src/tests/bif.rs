...
fn test_built_in_function_from_string() {
    ...
    assert_eq!(
        Bif::DistinctValues,
        Bif::from_str("distinct values").unwrap()
    );
    ...
    assert_eq!(
        Bif::OverlapsBefore,
        Bif::from_str("overlaps before").unwrap()
    );
    ...
    assert_eq!(
        Bif::SubstringAfter,
        Bif::from_str("substring after").unwrap()
    );
    assert_eq!(
        Bif::SubstringBefore,
        Bif::from_str("substring before").unwrap()
    );
    ...
    assert_eq!(
        Bif::YearsAndMonthsDuration,
        Bif::from_str("years and months duration").unwrap()
    );
}
