...
fn _0017() {
    te_null(
        ...
        &scope!(),
        r#" 1 * "a" "#,
        r#"[multiplication] incompatible types: 1 * "a""#,
    );
}
...
fn _0018() {
    te_null(
        ...
        &scope!(),
        r#" @"P4DT1H" * @"P2Y" "#,
        r#"[multiplication] incompatible types: P4DT1H * P2Y"#,
    );
}
...
fn _0019() {
    te_null(
        ...
        &scope!(),
        r#" @"P2Y" * @"P4DT1H" "#,
        r#"[multiplication] incompatible types: P2Y * P4DT1H"#,
    );
}
...
fn _0025() {
    te_null(
        ...
        &scope!(),
        r#" "a" * 2 "#,
        r#"unexpected value type in multiplication: string"#,
    );
}
