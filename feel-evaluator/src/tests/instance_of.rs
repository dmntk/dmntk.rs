...
fn _0010() {
    ...
    te_bool(
        false,
        scope,
        "Order instance of days and time duration",
        false,
    );
}
...
fn _0011() {
    ...
    te_bool(
        false,
        scope,
        "Order instance of years and months duration",
        false,
    );
}
...
fn _0026() {
    ...
    te_bool(
        false,
        scope,
        "Delivery Date instance of date and time",
        true,
    );
}
...
fn _0032() {
    ...
    te_bool(
        false,
        scope,
        "Delivery Duration instance of days and time duration",
        true,
    );
}
...
fn _0035() {
    ...
    te_bool(
        false,
        scope,
        "Delivery Duration instance of years and months duration",
        true,
    );
}
...
fn _0044() {
    ...
    te_bool(
        false,
        scope,
        "Orders instance of list<date and time>",
        false,
    );
}
...
fn _0045() {
    ...
    te_bool(
        false,
        scope,
        "Orders instance of list<years and months duration>",
        false,
    );
}
...
fn _0046() {
    ...
    te_bool(
        false,
        scope,
        "Orders instance of list<days and time duration>",
        false,
    );
}
...
fn _0053() {
    ...
    te_bool(
        false,
        scope,
        "Items instance of range<date and time>",
        false,
    );
}
...
fn _0054() {
    ...
    te_bool(
        false,
        scope,
        "Items instance of range<years and months duration>",
        false,
    );
}
...
fn _0055() {
    ...
    te_bool(
        false,
        scope,
        "Items instance of range<days and time duration>",
        false,
    );
}
...
fn _0056() {
    ...
    te_bool(
        false,
        scope,
        "Person instance of context<name:string>",
        true,
    );
}
...
fn _0058() {
    ...
    te_bool(
        false,
        scope,
        "Person instance of context<name:string,age:number,car:string>",
        false,
    );
}
...
fn _0059() {
    ...
    te_bool(
        false,
        scope,
        "Person instance of context<name:string,a:number>",
        false,
    );
}
...
fn _0060() {
    ...
    te_bool(
        false,
        scope,
        "Person instance of context<n:string,age:number>",
        false,
    );
}
...
fn _0064() {
    ...
    te_bool(
        false,
        scope,
        "multiple instance of function<number,number>->Any",
        true,
    );
}
...
#[test]
fn _0070() {
    let node = AstNode::InstanceOf(
        Box::new(AstNode::Irrelevant),
