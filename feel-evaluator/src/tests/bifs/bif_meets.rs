...
fn _0006() {
    te_bool(
        false,
        &scope!(),
        r#"meets(range1: [1..10], range2: [10..20])"#,
        true,
    );
}
...
fn _0007() {
    te_bool(
        false,
        &scope!(),
        r#"meets(range2: [1..10], range1: [10..20])"#,
        false,
    );
}
...
fn _0008() {
    te_bool(
        false,
        &scope!(),
        r#"meets(range2: [10..20], range1: [1..10])"#,
        true,
    );
}
