...
fn _0002() {
    te_number(
        false,
        &scope!(),
        r#"week of year(date and time("2019-09-17T00:00:00"))"#,
        38,
        0,
    );
}
...
fn _0003() {
    te_number(
        false,
        &scope!(),
        r#"week of year(date: date(2019,9,17))"#,
        38,
        0,
    );
}
...
fn _0004() {
    te_number(
        false,
        &scope!(),
        r#"week of year(date: date and time("2019-09-17T00:00:00"))"#,
        38,
        0,
    );
}
...
fn _0006() {
    te_null(
        false,
        &scope!(),
        r#"week of year(d: date(2021,9,17))"#,
