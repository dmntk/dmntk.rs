...
fn _0025() {
    te_string(
        false,
        &scope!(),
        r##"replace(input:"abc",pattern:"[a-z]",replacement:"#")"##,
        r##"###"##,
    );
}
...
fn _0031() {
    te_string(
        false,
        &scope!(),
        r##"replace("abc","[A-Z]","#","all unknown but i")"##,
        r##"###"##,
    );
}
...
fn _0034() {
    te_null(
        ...
        &scope!(),
        r#"replace()"#,
        r#"expected 3,4 parameters, actual number of parameters is 0"#,
    );
}
...
fn _0041() {
    te_null(
        ...
        &scope!(),
        r#"replace(10,"[a-z]","A")"#,
        r#"replace: input must be a string"#,
    );
}
...
fn _0042() {
    te_null(
        ...
        &scope!(),
        r#"replace("abc1",10,"A")"#,
        r#"replace: pattern must be a string"#,
    );
}
...
fn _0043() {
    te_null(
        false,
        &scope!(),
        r#"replace("abc1","[a-z]",10)"#,
        r#"replace: replacement must be a string"#,
    );
}
...
fn _0044() {
    te_null(
        false,
        &scope!(),
        r#"replace("abc1","[a-z","A")"#,
        r#"replace: invalid pattern"#,
    );
}
