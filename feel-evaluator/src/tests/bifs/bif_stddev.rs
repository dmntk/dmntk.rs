...
fn _0001() {
    te_be_value(
        ...
        &scope!(),
        r#"stddev(2,4,7,5)"#,
        r#"2.081665999466132735282297706979931"#,
    );
}
...
fn _0006() {
    te_be_value(
        ...
        &scope!(),
        r#"stddev(5,6,8,9)"#,
        r#"1.825741858350553711523232609336007"#,
    );
}
...
fn _0010() {
    te_null(
        ...
        &scope!(),
        r#"stddev([2])"#,
        r#"stddev: minimum two input arguments expected"#,
    );
}
...
fn _0013() {
    te_null(
        false,
        &scope!(),
        r#"stddev([exp(7075),-exp(7074)])"#,
        r#"stddev: result is not a finite number"#,
    );
}
