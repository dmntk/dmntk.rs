...
fn _0008() {
    te_null(
        ...
        &scope!(),
        "decimal(1/3, 6177)",
        "[core::decimal] scale is out of range: 6177",
    );
}
...
fn _0009() {
    te_null(
        ...
        &scope!(),
        "decimal(1/3, -6112)",
        "[core::decimal] scale is out of range: -6112",
    );
}
...
fn _0016() {
    te_null(
        false,
        &scope!(),
        "decimal(number: 1, scale: 2)",
        r#"parameter 'n' not found"#,
    );
}
