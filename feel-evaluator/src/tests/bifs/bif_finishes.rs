...
fn _0013() {
    te_bool(
        false,
        &scope!(),
        r#"finishes(point: 20,range: [1..20])"#,
        true,
    );
}
...
fn _0020() {
    te_bool(
        false,
        &scope!(),
        r#"finishes(time("12:18:03"),[time("12:00:00")..time("12:18:03")])"#,
        true,
    );
}
...
fn _0032() {
    te_bool(
        false,
        &scope!(),
        r#"finishes(duration("P2Y"),[duration("P1Y")..duration("P2Y")])"#,
        true,
    );
}
...
fn _0038() {
    te_bool(
        false,
        &scope!(),
        r#"finishes(range1: [1..20],range2: [5..20])"#,
        true,
    );
}
