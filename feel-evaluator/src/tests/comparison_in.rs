...
fn _0010() {
    te_bool(
        false,
        &scope!(),
        r#" @"2023-02-06T10:11:12" in @"2023-02-06T10:11:12" "#,
        true,
    );
}
...
fn _0011() {
    te_bool(
        false,
        &scope!(),
        r#" @"2023-02-06T10:11:12" in @"2023-02-06T10:11:13" "#,
        false,
    );
}
...
fn _0022() {
    ...
    te_bool(
        false,
        scope,
        r#"date("2018-12-04") in <= date("2018-12-05")"#,
        true,
    );
    ...
    te_bool(
        false,
        scope,
        r#"{a: "foo"} in [{b: "bar"}, {a: "foo"}]"#,
        true,
    );
    te_bool(
        false,
        scope,
        r#"duration("P11Y") in [duration("P8Y"),duration("P9Y"),duration("P10Y")]"#,
        false,
    );
}
...
fn _0039() {
    te_bool(
        false,
        &scope!(),
        r#" @"2023-02-06T10:11:23" in <= @"2023-02-06T10:11:23" "#,
        true,
    );
}
...
fn _0040() {
    te_bool(
        false,
        &scope!(),
        r#" @"2023-02-06T10:11:23" in <= @"2023-02-06T10:11:22" "#,
        false,
    );
}
...
fn _0041() {
    te_bool(
        false,
        &scope!(),
        r#" @"2023-02-06T10:11:23" in < @"2023-02-06T10:11:24" "#,
        true,
    );
}
...
fn _0044() {
    te_bool(
        false,
        &scope!(),
        r#" @"2023-02-06T10:11:21" in >= @"2023-02-06T10:11:22" "#,
        false,
    );
}
...
fn _0072() {
    te_bool(
        false,
        &scope!(),
        r#"duration("P11Y") in > duration("P10Y")"#,
        true,
    );
}
...
fn _0075() {
    te_null(
        ...
        &scope!(),
        r#" true in >= @"P2D" "#,
        "eval_in_unary_greater_or_equal",
    );
}
...
fn _0077() {
    te_null(
        ...
        &scope!(),
        r#" 1 in (function() 1) "#,
        "unexpected argument type in 'in' operator: function<>->Any",
    );
}
...
fn _0080() {
    te_bool(
        false,
        &scope!(),
        r#" @"10:11:12" in [@"10:11:10", @"10:11:11", @"10:11:12", @"10:11:13"] "#,
        true,
    );
}
...
fn _0081() {
    te_bool(
        false,
        &scope!(),
        r#" @"10:11:18" in [@"10:11:10", @"10:11:11", @"10:11:12" ,@"10:11:13"] "#,
        false,
    );
}
