...
fn _0007() {
    te_number_x(
        ...
        &scope!(),
        r#"1/3"#,
        r#"0.3333333333333333333333333333333333"#,
    );
}
...
fn _0010() {
    te_null(
        ...
        &scope!(),
        r#" 0.0 / "a" "#,
        r#"[division] incompatible types: 0.0 / "a""#,
    );
}
...
fn _0021() {
    te_null(
        ...
        &scope!(),
        r#" @"P10D" / "a" "#,
        r#"[division] incompatible types: P10D / "a""#,
    );
}
...
fn _0022() {
    te_null(
        ...
        &scope!(),
        r#" @"P10Y" / "a" "#,
        r#"[division] incompatible types: P10Y / "a""#,
    );
}
...
fn _0023() {
    te_null(
        ...
        &scope!(),
        r#" "a" / 2.21 "#,
        r#"[division] incompatible types: "a" / 2.21"#,
    );
}
