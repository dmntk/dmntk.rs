...
fn _0024() {
    te_null(
        false,
        &scope!(),
        r#" @"2021-11-01" <= "2021-11-02" "#,
        "eval_less_or_equal_date",
    );
}
...
fn _0036() {
    te_null(
        ...
        &scope!(),
        r#" @"P1D" <= "P1D" "#,
        "eval_less_or_equal_days_and_time_duration",
    );
}
...
fn _0040() {
    te_null(
        ...
        &scope!(),
        r#" @"P1Y" <= "P1Y" "#,
        "eval_less_or_equal_years_and_months_duration",
    );
}
