...
fn _0006() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2018-12-10T10:30:01").year"#,
        2018,
        0,
    );
}
...
fn _0007() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2018-12-10T10:30:01").month"#,
        12,
        0,
    );
}
...
fn _0008() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2018-12-10T10:30:01").day"#,
        10,
        0,
    );
}
...
fn _0009() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2018-12-10T11:30:01").hour"#,
        11,
        0,
    );
}
...
fn _0011() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2018-12-10T11:30:01").minute"#,
        30,
        0,
    );
}
...
fn _0012() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2018-12-10T11:30:01").second"#,
        1,
        0,
    );
}
...
fn _0013() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2021-02-10").hour"#,
        0,
        0,
    );
}
...
fn _0014() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2021-02-10").minute"#,
        0,
        0,
    );
}
...
fn _0015() {
    te_number(
        false,
        &scope!(),
        r#"date and time("2021-02-10").second"#,
        0,
        0,
    );
}
...
fn _0016() {
    te_value(
        false,
        &scope!(),
        r#"date and time("2018-12-10T10:30:00+05:00").time offset"#,
        r#"@"PT5H""#,
    );
}
...
fn _0023() {
    te_value(
        false,
        &scope!(),
        r#"time("08:45:27-05:00").time offset"#,
        r#"@"-PT5H""#,
    );
}
...
fn _0024() {
    te_null(
        false,
        &scope!(),
        r#"time("08:45:27").time offset"#,
        "could not retrieve time offset for time",
    );
}
...
fn _0025() {
    te_string(
        false,
        &scope!(),
        r#"time("08:45:27@Etc/UTC").timezone"#,
        r#"Etc/UTC"#,
    );
}
...
fn _0026() {
    te_null(
        false,
        &scope!(),
        r#"time("08:45:27").timezone"#,
        "could not retrieve timezone for time",
    );
}
...
fn _0031() {
    te_null(
        ...
        &scope!(),
        r#"duration("P1Y").days"#,
        "no such property in years and months duration: days",
    );
}
...
fn _0032() {
    te_null(
        false,
        &scope!(),
        r#"duration("P1Y").hours"#,
        "no such property in years and months duration: hours",
    );
}
...
fn _0033() {
    te_null(
        false,
        &scope!(),
        r#"duration("P1Y").minutes"#,
        "no such property in years and months duration: minutes",
    );
}
...
fn _0034() {
    te_null(
        false,
        &scope!(),
        r#"duration("P1Y").seconds"#,
        "no such property in years and months duration: seconds",
    );
}
...
fn _0035() {
    te_null(
        false,
        &scope!(),
        r#"duration("P1D").years"#,
        "no such property in days and time duration: years",
    );
}
...
fn _0036() {
    te_null(
        false,
        &scope!(),
        r#"duration("P1D").months"#,
        "no such property in days and time duration: months",
    );
}
...
fn _0047() {
    te_number(
        false,
        &scope!(),
        r#"duration("P3DT15H47M13S").hours"#,
        15,
        0,
    );
}
...
fn _0048() {
    te_number(
        false,
        &scope!(),
        r#"duration("P3DT15H47M13S").minutes"#,
        47,
        0,
    );
}
...
fn _0049() {
    te_number(
        false,
        &scope!(),
        r#"duration("P3DT15H47M13S").seconds"#,
        13,
        0,
    );
}
...
fn _0050() {
    te_null(
        false,
        &scope!(),
        r#" @"999999999-12-06".weekday"#,
        "could not retrieve weekday for date",
    );
}
...
fn _0051() {
    te_null(
        false,
        &scope!(),
        r#" @"2023-02-06".weekdays"#,
        "no such property in date: weekdays",
    );
}
...
fn _0052() {
    te_null(
        false,
        &scope!(),
        r#" @"999999999-12-06T10:11:12".weekday"#,
        "could not retrieve weekday for date and time",
    );
}
...
fn _0054() {
    te_null(
        false,
        &scope!(),
        r#" @"2023-02-06T10:11:12".weekdays"#,
        "no such property in date and time: weekdays",
    );
}
...
fn _0055() {
    te_null(
        ...
        &scope!(),
        r#" @"10:11:12".weekdays"#,
        "no such property in time: weekdays",
    );
}
...
fn _0056() {
    te_null(
        ...
        &scope!(),
        r#" false.weekdays "#,
        "unexpected type: boolean, for property: weekdays",
    );
}
...
fn _0063() {
    te_null(
        ...
        &scope!(),
        r#" [1..10].spread "#,
        "no such property in range: spread",
    );
}
...
fn _0065() {
    te_null(
        ...
        &scope!(),
        r#" >1.end "#,
        "no such property in unary greater: end",
    );
}
...
fn _0069() {
    te_null(
        ...
        &scope!(),
        r#" >=1.end "#,
        "no such property in unary greater or equal: end",
    );
}
...
fn _0072() {
    te_null(
        ...
        &scope!(),
        r#" <1.start "#,
        "no such property in unary less: start",
    );
}
...
fn _0076() {
    te_null(
        ...
        &scope!(),
        r#" <=1.start "#,
        "no such property in unary less or equal: start",
    );
}
