...
fn _0009() {
    te_bool(
        false,
        &scope!(),
        r#"5 - 2 - 0.1 between 1 + 2 and 10.2/2"#,
        false,
    );
}
...
fn _0012() {
    te_bool(
        false,
        &scope!(),
        r#"(2 between 1 and 4) = (5 between 3 and 8)"#,
        true,
    );
}
...
fn _0020() {
    te_bool(
        false,
        &scope!(),
        r#" @"2023-02-14" between @"2023-02-01" and @"2023-02-11" "#,
        false,
    );
}
...
fn _0024() {
    te_bool(
        false,
        &scope!(),
        r#" @"10:11:32" between @"10:11:10" and @"10:11:15" "#,
        false,
    );
}
