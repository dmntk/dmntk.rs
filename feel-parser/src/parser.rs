        ...
        loop {
            match action {
                Action::NewState => {
                    ...
                    if self.yy_n < 0
                        || YY_LAST < self.yy_n
                        || YY_CHECK[self.yy_n as usize] != yy_token_code
                    {
                        action = Action::Default;
                        continue;
                    }
                ...
                Action::Reduce => {
                    ...
                    self.yy_state =
                        if (0..=YY_LAST).contains(&yy_i) && YY_CHECK[yy_i as usize] == top_state {
...
impl<'parser> ReduceActions for Parser<'parser> {
    ...
    fn action_addition(&mut self) -> Result<()> {
        ...
        self.yy_node_stack
            .push(AstNode::Add(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_between(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack.push(AstNode::Between(
            Box::new(lhs),
            Box::new(mhs),
            Box::new(rhs),
        ));
    ...
    fn action_built_in_type_name(&mut self) -> Result<()> {
        ...
        if let TokenValue::BuiltInTypeName(name) =
            &self.yy_value_stack[self.yy_value_stack.len() - 1]
        {
    ...
    fn action_comparison_eq(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Eq(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_comparison_ge(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Ge(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_comparison_gt(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Gt(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_comparison_in(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::In(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_comparison_le(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Le(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_comparison_lt(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Lt(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_comparison_nq(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Nq(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_conjunction(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::And(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_context_entry(&mut self) -> Result<()> {
        ...
        self.yy_node_stack.push(AstNode::ContextEntry(
            Box::new(key_node),
            Box::new(value_node),
        ));
        Ok(())
    ...
    fn action_context_type_entry(&mut self) -> Result<()> {
        ...
        if let TokenValue::Name(name) =
            &self.yy_value_stack[self.yy_value_stack.len() - self.yy_len as usize]
        {
    ...
    fn action_disjunction(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Or(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_division(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Div(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_every(&mut self) -> Result<()> {
        ...
        self.yy_node_stack
            .push(AstNode::Every(Box::new(lhs), satisfies));
        Ok(())
    }
    ...
    fn action_exponentiation(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Exp(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_filter(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Filter(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_for(&mut self) -> Result<()> {
        ...
        self.yy_node_stack
            .push(AstNode::For(Box::new(lhs), Box::new(evaluated_expression)));
        Ok(())
    }
    ...
    fn action_formal_parameter_with_type(&mut self) -> Result<()> {
            ...
            &self.yy_value_stack[self.yy_value_stack.len() - self.yy_len as usize]
        {
            ...
            self.yy_node_stack
                .push(AstNode::FormalParameter(parameter_name, parameter_type));
    ...
    fn action_formal_parameters_first(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::FormalParameters(vec![lhs]));
        Ok(())
    }
    ...
    fn action_function_body(&mut self) -> Result<()> {
        ...
        if let Some(function_body_node) = self.yy_node_stack.pop() {
            self.yy_node_stack
                .push(AstNode::FunctionBody(Box::new(function_body_node), false));
        }
    ...
    fn action_function_body_external(&mut self) -> Result<()> {
        ...
        if let Some(function_body_node) = self.yy_node_stack.pop() {
            self.yy_node_stack
                .push(AstNode::FunctionBody(Box::new(function_body_node), true));
        }
        // pop temporary context from the top of scope stack
        self.scope.pop();
        Ok(())
    ...
    fn action_function_definition(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::FunctionDefinition(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_function_invocation(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::FunctionInvocation(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_function_type(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::FunctionType(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_if(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::If(Box::new(lhs), Box::new(mid), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_instance_of(&mut self) -> Result<()> {
        ...
        self.yy_node_stack
            .push(AstNode::InstanceOf(checked_value, expected_type));
        Ok(())
    }
    ...
    fn action_interval(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Range(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_interval_end(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::IntervalEnd(Box::new(lhs), closed));
        Ok(())
    }
    ...
    fn action_interval_start(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::IntervalStart(Box::new(lhs), closed));
        Ok(())
    }
    ...
    fn action_iteration_contexts_tail(&mut self) -> Result<()> {
        ...
        self.yy_node_stack
            .push(AstNode::IterationContexts(vec![node]));
        Ok(())
    }
    ...
    fn action_key_name(&mut self) -> Result<()> {
        ...
        if let Some(TokenValue::Name(name)) = self.yy_value_stack.last() {
            self.yy_node_stack
                .push(AstNode::ContextEntryKey(name.clone()));
        }
        Ok(())
    }
    ...
    fn action_key_string(&mut self) -> Result<()> {
        ...
        if let Some(TokenValue::String(value)) = self.yy_value_stack.last() {
            self.yy_node_stack
                .push(AstNode::ContextEntryKey(Name::from(value.clone())));
        }
        Ok(())
    }
    ...
    fn action_literal_numeric(&mut self) -> Result<()> {
        ...
        if let Some(TokenValue::Numeric(before, after)) = self.yy_value_stack.last() {
            self.yy_node_stack
                .push(AstNode::Numeric(before.clone(), after.clone()));
        }
        Ok(())
    }
    ...
    fn action_multiplication(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Mul(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
    ...
    fn action_named_parameter(&mut self) -> Result<()> {
        ...
        if let TokenValue::Name(name) = &self.yy_value_stack[self.yy_value_stack.len() - 3] {
            ...
            self.yy_node_stack
                .push(AstNode::NamedParameter(parameter_name, parameter_value));
        }
        Ok(())
    }
    ...
    fn action_named_parameters_tail(&mut self) -> Result<()> {
        ...
        self.yy_node_stack
            .push(AstNode::NamedParameters(vec![node]));
        Ok(())
    }
    ...
    fn action_path(&mut self) -> Result<()> {
        ...
        if let Some(TokenValue::Name(name)) = &self.yy_value_stack.last() {
            ...
            self.yy_node_stack
                .push(AstNode::Path(Box::new(lhs), Box::new(rhs)));
        }
        Ok(())
    }
    ...
    fn action_positional_parameters_tail(&mut self) -> Result<()> {
        ...
        if let AstNode::PositionalParameters(mut items) = node {
            ...
            items.insert(0, item);
            self.yy_node_stack
                .push(AstNode::PositionalParameters(items));
            return Ok(());
        }
        self.yy_node_stack
            .push(AstNode::PositionalParameters(vec![node]));
        Ok(())
    }
    ...
    fn action_qualified_name(&mut self) -> Result<()> {
        ...
        if let Some(TokenValue::Name(name)) = &self.yy_value_stack.last() {
            self.yy_node_stack
                .push(AstNode::QualifiedName(vec![AstNode::QualifiedNameSegment(
                    name.clone(),
                )]));
        }
        Ok(())
    ...
    fn action_quantified_expressions_tail(&mut self) -> Result<()> {
        ...
        self.yy_node_stack
            .push(AstNode::QuantifiedContexts(vec![node]));
        Ok(())
    }
    ...
    fn action_some(&mut self) -> Result<()> {
        ...
        let satisfies = Box::new(AstNode::Satisfies(Box::new(rhs)));
        self.yy_node_stack
            .push(AstNode::Some(Box::new(lhs), satisfies));
        Ok(())
    }
    ...
    fn action_subtraction(&mut self) -> Result<()> {
        ...
        let lhs = self.yy_node_stack.pop().unwrap();
        self.yy_node_stack
            .push(AstNode::Sub(Box::new(lhs), Box::new(rhs)));
        Ok(())
    }
